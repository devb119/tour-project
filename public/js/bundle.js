...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGV2YjExOSIsImEiOiJja3ZwNHV3dXAwcGF0MnVxdjZlcTVveXlpIn0.YgbQWa_2GCJ4wit1fmr37A';
...
},{}],"displayChart.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.displayChart = void 0;
...
var displayChart = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var chart1, delayed, res, _yield$res$json, data, thisYear, lastYear, topTour, labels, sales, tourNames, bookingTimes, myChart, chart2, myChart2;

    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            chart1 = document.getElementById('my-chart').getContext('2d');
            _context.next = 3;
            return fetch('/api/v1/bookings/stats');
          ...
          case 6:
            ...
            thisYear = data.thisYear, lastYear = data.lastYear, topTour = data.topTour;
            labels = [];
            sales = [];
            lastYear.forEach(function (el) {
              labels.push("".concat(el._id, "/").concat(el.year));
              sales.push(el.sales);
            });
            thisYear.forEach(function (el) {
              labels.push("".concat(el._id, "/").concat(el.year));
              sales.push(el.sales);
            });
            tourNames = [];
            bookingTimes = [];
            topTour.forEach(function (el) {
            ...
            chart2 = document.getElementById('my-chart-2').getContext('2d');
...
exports.displayChart = displayChart;
...
var stripe = Stripe('pk_test_51JwHK7LJ438FhWmEuIZEr3gK40Q3IHwltDMo4pFDraDwQbbWQIAxXKPsbi7LUzNTfsvHAls1i3oeWvE6eup0hdH800gG0fotNl');
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"deleteBooking.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.status === 204) {
              (0, _alert.showAlert)('success', "Booking has been deleted successfully!");
              window.setTimeout(function () {
                location.reload(true);
              }, 2000);
            }
...
var _displayChart = require("./displayChart");
...
var chart1 = document.getElementById('my-chart');
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var savePasswordBtn, currentPassword, newPassword, newPasswordConfirm;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
  ...
  cardContainer.addEventListener('click', function (e) {
    ...
    if (reviewBtn) {
      var _reviewBtn$dataset$to = reviewBtn.dataset.tour.split(','),
          _reviewBtn$dataset$to2 = _slicedToArray(_reviewBtn$dataset$to, 3),
          tourId = _reviewBtn$dataset$to2[0],
          name = _reviewBtn$dataset$to2[1],
          imageCover = _reviewBtn$dataset$to2[2];

      console.log(tourId, name, imageCover);
      reviewTourId = tourId;
      reviewForm.querySelector('.card__picture-img').src = "/img/tours/".concat(imageCover);
...
if (saveRvBtn) {
  saveRvBtn.addEventListener('click', /*#__PURE__*/function () {
...
var bookingsTable = document.querySelector('#booking');
...
if (bookingsTable) {
  bookingsTable.addEventListener('click', function (e) {
    ...
    if (deleteBtn) {
      var bookingId = deleteBtn.dataset.bookingId;
      confirmBox.classList.remove('hidden');
      overlay.classList.remove('hidden');
      var cancel = document.getElementById('cancel');
      var confirm = document.getElementById('confirm');
      ...
      confirm.addEventListener('click', function () {
        return (0, _deleteBooking.deleteBooking)(bookingId);
      });
    }
  });
} ////////////////////////DASHBOARD//////////////////////////
