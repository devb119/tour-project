...
var reviewForm = document.querySelector('.reviews_box'); // VALUES
  ...
  cardContainer.addEventListener('click', function (e) {
    ...
    if (reviewBtn) {
      var _reviewBtn$dataset$to = reviewBtn.dataset.tour.split(','),
          _reviewBtn$dataset$to2 = _slicedToArray(_reviewBtn$dataset$to, 2),
          name = _reviewBtn$dataset$to2[0],
          imageCover = _reviewBtn$dataset$to2[1];
